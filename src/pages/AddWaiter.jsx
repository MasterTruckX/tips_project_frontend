    ...
    <>
      <div className='form-container'>
        ...
        <form onSubmit={onSubmit}>
            ...
            <div className="form-group">
            <button type="button" className="btn btn-outline-primary" onClick={goToNewDate} style={{marginTop: '50px'}}>Go To New Date</button>
            </div>
            <div className="form-group">
            <button type="button" className="btn btn-outline-primary" onClick={goToNewWaiter} style={{marginTop: '10px'}}>Go To New Waiter</button>
            </div>
        </form>
        </section>
      </div>
